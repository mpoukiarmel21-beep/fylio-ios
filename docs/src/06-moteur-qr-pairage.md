# FYLIO V2 — `FylioCore/FylioQRPairing.swift` (QR réel mode SHAREit — connexion Wi-Fi directe)
...
public final class FylioQRPairingService: @unchecked Sendable {
    ...
    public func sessionKey(forPeerEphemeralPublicKey peerPublicB64: String,
        ...
        return try local.sharedSecretFromKeyAgreement(
            with: Curve25519.KeyAgreement.PrivateKey(rawRepresentation: peerData).publicKey)
