# FYLIO — `FylioUI/AppViewModel+Storage.swift` (bloc 3/3 — VERSION PROPRE, sans coquille)
...
final class FylioStorage: @unchecked Sendable {
    ...
    func importFiles(_ urls: [URL]) {
        for url in urls {
            let destination = receivedDir.appendingPathComponent(url.lastPathComponent)
