# FYLIO — `FylioUI/DesignSystem/FylioDesign2.swift` — **VERSION CORRIGÉE INTÉGRALE**
**(Agent Design Étapes 3+ : icônes appareil, états, états vides animés, objet de progression, barre)**
...
public struct FylioDeviceIcon: View {
    ...
    public var body: some View {
        Image("device_\(platform.rawValue)")
            .resizable().scaledToFit()
            .frame(width: size, height: size)
    }
}

// MARK: - Style de pression (état pressé : rétrécissement + opacité légers)

public struct FylioPressStyle: ButtonStyle {
    public init() {}
