# FYLIO — `FylioUI/Screens/ReceiveView.swift`

```swift
import SwiftUI
import CoreImage.CIFilterBuiltins

/// RECEVOIR — nom + numéro Fylio, QR sécurisé (aucune donnée sensible en clair),
/// connexions disponibles, demandes entrantes, animation d'attente, accepter/refuser.
...
struct ReceiveView: View {
    ...
    // MARK: QR (personnages haut/bas autour du code — style maquette QR)
    ...
    // MARK: Demandes entrantes (accepter / refuser — confirmation obligatoire)
...
/// {num, fp, eph-pub, port, proto} — jamais de secret en clair (règle QR).
