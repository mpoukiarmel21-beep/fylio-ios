# FYLIO — `FylioUI/DesignSystem/FylioDesign.swift` (Agent Design / Étapes 2-3)
**DA extraite fidèlement de la maquette « 0-pages d'accueil » (Pages.txt) — glassmorphism, palette, rayons, états.**
...
// MARK: - Icône appareil par plateforme (enseignements SHAREit : éléments 5/6/7)
